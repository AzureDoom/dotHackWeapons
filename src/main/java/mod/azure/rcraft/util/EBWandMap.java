...
public class EBWandMap {
	...
	public static void populateWandMap(){
		...
		WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.MAGIC), wavemaster72);
		WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.MAGIC), wavemaster73);
		WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.MAGIC), harvestcleric1);
		WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.MAGIC), wavemaster20);
		WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.MAGIC), wavemaster34);
		WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.MAGIC), shadowwarlock10);
		WAND_MAP.put(ImmutablePair.of(Tier.APPRENTICE, Element.MAGIC), wavemaster72p);
		WAND_MAP.put(ImmutablePair.of(Tier.APPRENTICE, Element.MAGIC), wavemaster73p);
		WAND_MAP.put(ImmutablePair.of(Tier.APPRENTICE, Element.MAGIC), harvestcleric1p);
		WAND_MAP.put(ImmutablePair.of(Tier.APPRENTICE, Element.MAGIC), wavemaster20p);
		WAND_MAP.put(ImmutablePair.of(Tier.APPRENTICE, Element.MAGIC), wavemaster34p);
		WAND_MAP.put(ImmutablePair.of(Tier.APPRENTICE, Element.MAGIC), shadowwarlock10p);
		WAND_MAP.put(ImmutablePair.of(Tier.ADVANCED, Element.MAGIC), wavemaster72a);
		WAND_MAP.put(ImmutablePair.of(Tier.ADVANCED, Element.MAGIC), wavemaster73a);
		WAND_MAP.put(ImmutablePair.of(Tier.ADVANCED, Element.MAGIC), harvestcleric1a);
		WAND_MAP.put(ImmutablePair.of(Tier.ADVANCED, Element.MAGIC), wavemaster20a);
		WAND_MAP.put(ImmutablePair.of(Tier.ADVANCED, Element.MAGIC), wavemaster34a);
		WAND_MAP.put(ImmutablePair.of(Tier.ADVANCED, Element.MAGIC), shadowwarlock10a);
		WAND_MAP.put(ImmutablePair.of(Tier.MASTER, Element.MAGIC), wavemaster72m);
		WAND_MAP.put(ImmutablePair.of(Tier.MASTER, Element.MAGIC), wavemaster73m);
		WAND_MAP.put(ImmutablePair.of(Tier.MASTER, Element.MAGIC), harvestcleric1m);
		WAND_MAP.put(ImmutablePair.of(Tier.MASTER, Element.MAGIC), wavemaster20m);
		WAND_MAP.put(ImmutablePair.of(Tier.MASTER, Element.MAGIC), wavemaster34m);
		WAND_MAP.put(ImmutablePair.of(Tier.MASTER, Element.MAGIC), shadowwarlock10m);
