...
public final class DotHackItems {
	...
	public static void registerItems(final RegistryEvent.Register<Item> event) {
		...
		for (int i = 1; i <= 25; i++)
			event.getRegistry()
					.register(dualswords = new ItemBaseSword("dualswords" + i, (2 + i) / 5)
							.setCreativeTab(DotHackTabs.SWORDS).setRegistryName(location("dualswords" + i))
							.setTranslationKey("dualswords" + i));
		for (int i = 1; i <= 20; i++)
			event.getRegistry()
					.register(edgepunisher = new ItemBaseSword("edgepunisher" + i, (3 + i) / 3)
							.setCreativeTab(DotHackTabs.SWORDS).setRegistryName(location("edgepunisher" + i))
							.setTranslationKey("edgepunisher" + i));
		for (int i = 1; i <= 9; i++)
			event.getRegistry().registerAll(
					flickreaper = new ItemBaseSword("flickreaper" + i, (20 + i) / 3).setCreativeTab(DotHackTabs.SWORDS)
							.setRegistryName(location("flickreaper" + i)).setTranslationKey("flickreaper" + i),
					lordpartizan = new ItemBaseSword("lordpartizan" + i, (16 + i) / 2).setCreativeTab(DotHackTabs.SWORDS)
							.setRegistryName(location("lordpartizan" + i)).setTranslationKey("lordpartizan" + i));
		for (int i = 1; i <= 11; i++)
			event.getRegistry()
					.register(tribalgrappler = new ItemBaseSword("tribalgrappler" + i, (20 + i) / 5)
							.setCreativeTab(DotHackTabs.SWORDS).setRegistryName(location("tribalgrappler" + i))
							.setTranslationKey("tribalgrappler" + i));
		for (int i = 1; i <= 75; i++)
			event.getRegistry()
					.register(blademaster = new ItemBaseSword("blademaster" + i, (3 + i) / 10)
							.setCreativeTab(DotHackTabs.SWORDS).setRegistryName(location("blademaster" + i))
							.setTranslationKey("blademaster" + i));
		for (int i = 1; i <= 73; i++)
			event.getRegistry()
					.register(heavyaxeman = new ItemBaseSword("heavyaxeman" + i, (11 + i) / 7)
							.setCreativeTab(DotHackTabs.SWORDS).setRegistryName(location("heavyaxeman" + i))
							.setTranslationKey("heavyaxeman" + i));
		for (int i = 1; i <= 54; i++)
			event.getRegistry()
					.register(heavyblade = new ItemBaseSword("heavyblade" + i, (81 + i) / 15)
							.setCreativeTab(DotHackTabs.SWORDS).setRegistryName(location("heavyblade" + i))
							.setTranslationKey("heavyblade" + i));
		for (int i = 1; i <= 41; i++)
			event.getRegistry()
					.register(heavyblade = new ItemBaseSword("heavybladev" + i, (94 + i) / 15)
							.setCreativeTab(DotHackTabs.SWORDS).setRegistryName(location("heavybladev" + i))
							.setTranslationKey("heavybladev" + i));
		for (int i = 1; i <= 71; i++)
			event.getRegistry()
					.register(longarm = new ItemBaseSword("longarm" + i, (4 + i) / 9).setCreativeTab(DotHackTabs.SWORDS)
							.setRegistryName(location("longarm" + i)).setTranslationKey("longarm" + i));
		for (int i = 1; i <= 81; i++)
			event.getRegistry()
					.register(twinblade = new ItemBaseSword("twinblade" + i, (2 + i) / 15)
							.setCreativeTab(DotHackTabs.SWORDS).setRegistryName(location("twinblade" + i))
							.setTranslationKey("twinblade" + i));
		for (int i = 1; i <= 4; i++)
		...
		for (int i = 1; i <= 18; i++)
			event.getRegistry().register(steamgunner = new ItemBow().setCreativeTab(DotHackTabs.GUNS)
		...
		if (Loader.isModLoaded("baubles")) {
			event.getRegistry().register(datadrain = new BaublesHeadItem().setCreativeTab(DotHackTabs.EXTRA)
		...
		if (Loader.isModLoaded("ebwizardry")) {
			event.getRegistry().registerAll(
					...
					new ItemEBWand20(Tier.NOVICE, Element.SORCERY).setCreativeTab(DotHackTabs.MAGIC)
			...
			for (int i = 1; i <= 10; i++)
				event.getRegistry().register(harvestcleric = new ItemMSStaff().setCreativeTab(DotHackTabs.MAGIC)
						.setRegistryName(location("harvestcleric" + i)));
			for (int i = 1; i <= 5; i++)
				event.getRegistry().register(macabredancer = new ItemMSStaff().setCreativeTab(DotHackTabs.MAGIC)
						.setRegistryName(location("macabredancer" + i)));
			for (int i = 1; i <= 14; i++)
				event.getRegistry().register(shadowwarlock = new ItemMSStaff().setCreativeTab(DotHackTabs.MAGIC)
						.setRegistryName(location("shadowwarlock" + i)));
			for (int i = 1; i <= 74; i++)
				event.getRegistry().register(wavemaster = new ItemMSStaff().setCreativeTab(DotHackTabs.MAGIC)
			...
			for (int i = 1; i <= 9; i++)
				event.getRegistry().register(harvestcleric = new ItemBow().setCreativeTab(DotHackTabs.MAGIC)
						.setRegistryName(location("harvestcleric" + i)));
			for (int i = 1; i <= 5; i++)
				event.getRegistry().register(macabredancer = new ItemBow().setCreativeTab(DotHackTabs.MAGIC)
						.setRegistryName(location("macabredancer" + i)));
			for (int i = 1; i <= 14; i++)
				event.getRegistry().register(shadowwarlock = new ItemBow().setCreativeTab(DotHackTabs.MAGIC)
						.setRegistryName(location("shadowwarlock" + i)));
			for (int i = 1; i <= 74; i++)
				event.getRegistry().register(wavemaster = new ItemBow().setCreativeTab(DotHackTabs.MAGIC)
						.setRegistryName(location("wavemaster" + i)));
