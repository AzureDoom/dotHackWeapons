...
public final class DotHackItems {
	...
	public static void populateWandMap() {
		...
		ONE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster27p);
		TWO_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster17p);
		THREE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster10p);
		FOUR_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster6p);
		FIVE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster3p);
		SIX_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster58p);
		SEVEN_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster53p);
		EIGHT_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster66p);
		NINE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), harvestcleric8p);		
		ONE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster27a);
		TWO_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster17a);
		THREE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster10a);
		FOUR_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster6a);
		FIVE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster3a);
		SIX_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster58a);
		SEVEN_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster53a);
		EIGHT_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster66a);
		NINE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), harvestcleric8a);
		ONE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster27m);
		TWO_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster17m);
		THREE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster10m);
		FOUR_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster6m);
		FIVE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster3m);
		SIX_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster58m);
		SEVEN_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster53m);
		EIGHT_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), wavemaster66m);
		NINE_WAND_MAP.put(ImmutablePair.of(Tier.NOVICE, Element.ICE), harvestcleric8m);
