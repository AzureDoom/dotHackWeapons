...
public class ItemEBWand10 extends ItemWand {

	public ItemEBWand10(Tier tier, Element element) {
		super(tier, element);
		this.tier = tier;
	...
	public boolean onApplyButtonPressed(EntityPlayer player, Slot centre, Slot crystals, Slot upgrade, Slot[] spellBooks){		
		...
		if(upgrade.getStack().getItem() == WizardryItems.arcane_tome){
			...
			if((player.isCreative() || Wizardry.settings.legacyWandLevelling
				...
				ItemStack newWand = new ItemStack(DotHackItems.get1Wand(tier, this.element));
